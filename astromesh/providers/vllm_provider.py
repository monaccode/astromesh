"""vLLM provider adapter for the Astromesh Agent Runtime."""
...
class VLLMProvider:
    """Provider adapter for a vLLM OpenAI-compatible endpoint."""

    def __init__(self, config: dict[str, Any] | None = None) -> None:
        config = config or {}
        self.base_url: str = config.get("base_url", "http://localhost:8000")
