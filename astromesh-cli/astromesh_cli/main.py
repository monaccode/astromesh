"""astromeshctl — Astromesh CLI management tool."""

import importlib.metadata

import typer

from astromesh_cli import __version__
from astromesh_cli.commands import (
    agents,
    ask,
    dev,
    doctor,
...
app = typer.Typer(
    name="astromeshctl",
    help="Astromesh CLI — manage nodes and clusters.",
