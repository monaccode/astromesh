...
export const COMPONENTS: Component[] = [
  {
    ...
    latest: 'Bumped minimum `astromesh` dependency to `>=0.40.0` so the ADK stays in sync with the latest runtime.',
  ...
  },
  {
    ...
    latest: 'Bumped minimum `astromesh` dependency to `>=0.40.0` and `astromesh-cli` to `>=0.3.0`.',
  ...
  },
  {
    ...
    latest: 'The baked runtime jumps sixteen releases to core v0.55.0. Each bump records in the pin file what was verified first — no new import on the boot-sensitive paths, the slim-install test, and a real .deb booting in a container.',
  ...
  },
  {
    ...
    latest: 'Release aligned with the rest of the suite; no dependency changes.',
  ...
  },
  {
    ...
    latest: 'Bumped minimum `astromesh` dependency to `>=0.40.0` so the CLI matches the latest runtime.',
