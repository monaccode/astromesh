...
export const COMPONENTS: Component[] = [
  {
    ...
    latest: 'Bumped the core runtime floor to astromesh>=0.40.0.',
  ...
  },
  {
    ...
    latest:
      '`map` can invoke a capability per item in parallel, `predefined`/`initial_env` bindings, max concurrency (`max_fanout`), and several compiler/execution fixes.',
  ...
  },
  {
    ...
    latest: 'Bumped the core runtime floor to astromesh>=0.40.0 and CLI floor to astromesh-cli>=0.2.1.',
