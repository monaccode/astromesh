...
<Aside type="tip">
**Source of truth:** the [`monaccode/astromesh-os`](https://github.com/monaccode/astromesh-os) repository. The commands here track its `README` and GitHub Actions workflows; if anything drifts, the repository is authoritative.
</Aside>
